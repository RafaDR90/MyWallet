      ...
      <div className="bg-dark-surface rounded-lg shadow-lg p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between mb-4">
            <Link 
              to="/forgot-password" 
              className="text-sm text-dark-primary hover:opacity-80 transition-opacity"
            >
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center gap-2 bg-white text-gray-700 
                     border border-gray-300 rounded-lg px-4 py-2 hover:bg-gray-50 
                     active:scale-[0.98] active:bg-gray-100 transition-all"
          >
